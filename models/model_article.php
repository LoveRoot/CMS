    ...
    class model_article extends Model
    {
        ...
        public function GetShortNews($p_id)
        {
            $result = new Pagination("Select a.id, a.title as a_title, a.link, a.author, a.date,
                                             ...
                                             From article as a, pages as  p where a.status = 1 and a.p_id = '" . intval($p_id) . "' and p.id = a.p_id", "Select id From article as a where a.status = 1 and a.p_id = '" . intval($p_id) . "'", 10);
            return $result;
        }
